...
This project is indexed by GitNexus as **chrome-extention-hub** (992 symbols, 2711 relationships, 71 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/chrome-extention-hub/context` | Codebase overview, check index freshness |
| `gitnexus://repo/chrome-extention-hub/clusters` | All functional areas |
| `gitnexus://repo/chrome-extention-hub/processes` | All execution flows |
| `gitnexus://repo/chrome-extention-hub/process/{name}` | Step-by-step execution trace |
